...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    ...
    <form class="form-inline my-2 my-lg-0">
      ...
      <input required class="form-control mr-sm-2"  placeholder="Cédula" aria-label="Search">
      
      <label for="">Ingrese contraseña:  </label>
      <input required class="form-control mr-sm-2" type="password" placeholder="Contraseña" aria-label="Search">
      
      <button class="btn btn-outline-success my-2 my-sm-0">Ingresar</button>
